...
export const etfCatalog: ETF[] = [
  ...
  mk(
    "RSST",
    [usLargeBlend, { exposure: { assetClass: "Trend" }, amount: 1 }],
    "Stacked",
  ),
  mk(
    "RSIT",
    [intlLargeBlend, { exposure: { assetClass: "Trend" }, amount: 1 }],
    "Stacked",
  ),
  mk(
    "RSSX",
  ...
  mk(
    ...
    [
      ...
      { exposure: { assetClass: "Trend" }, amount: 1 },
    ],
    "Stacked",
  ),
  mk(
    "RSSY",
    [usLargeBlend, { exposure: { assetClass: "Carry" }, amount: 1 }],
    "Stacked",
  ),
  mk(
    "RSBY",
    [
      { exposure: { assetClass: "U.S. Treasuries" }, amount: 1 },
      { exposure: { assetClass: "Carry" }, amount: 1 },
    ],
    "Stacked",
  ),
  mk(
  ...
  mk(
    "SPLS",
    [usLargeBlend, { exposure: { assetClass: "U.S. Treasuries" }, amount: 1 }],
    "Stacked",
  ),
  ...
  mk(
    "TMF",
    [{ exposure: { assetClass: "U.S. Treasuries" }, amount: 3 }],
    "Daily Reset",
  ),
  mk(
    "UBT",
    [{ exposure: { assetClass: "U.S. Treasuries" }, amount: 2 }],
    "Daily Reset",
  ),
  mk(
    "ZROZ",
  ...
  mk(
    "GDE",
    [
      { exposure: usLargeBlend.exposure, amount: 0.9 },
  ...
  mk(
    "BTGD",
    [
      { exposure: { assetClass: "Bitcoin" }, amount: 1 },
      { exposure: { assetClass: "Gold" }, amount: 1 },
    ],
    "Stacked",
  ),
  ...
  mk(
    "NTSI",
    [
      { exposure: intlLargeBlend.exposure, amount: 0.9 },
      { exposure: { assetClass: "U.S. Treasuries" }, amount: 0.6 },
    ],
    "Stacked",
  ),
  mk(
    "NTSE",
    [
      { exposure: emLargeBlend.exposure, amount: 0.9 },
      { exposure: { assetClass: "U.S. Treasuries" }, amount: 0.6 },
    ],
    "Stacked",
  ),
  mk(
    ...
    [
      { exposure: usLargeBlend.exposure, amount: 0.9 },
      { exposure: intlLargeBlend.exposure, amount: 0.6 },
    ],
    "Stacked",
  ),

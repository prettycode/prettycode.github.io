...
import type {
    ...
    SizeFactor,
    ColorMap,
} from '@/features/portfolio/core/domain/Exposure';
import type { ExpandedCategories } from './Analysis';
...
const DetailedExposures: React.FC<DetailedExposuresProps> = ({
     ...
     */
    const DetailedExposureCard: React.FC<DetailedExposureCardProps> = ({
        id,
        title,
        icon,
        exposuresAbs,

...
export const TAX_EXEMPT_MUNI_ETFS: BondETF[] = [
    ...
    {
        ticker: 'VTEB',
        name: 'Vanguard Tax-Exempt Bond Index Fund ETF',
        duration: 'total-market',
        managementStyle: 'passive',
        yield: 3.51,
        expenseRatio: 0.03,
    },
...
export const TAXABLE_TREASURY_ETFS: BondETF[] = [
    ...
    {
        ticker: 'VTG',
        name: 'Vanguard Total Treasury ETF',
        duration: 'total-market',
        managementStyle: 'passive',
        yield: 3.89,
        expenseRatio: 0.03,
    ...
    {
        ticker: 'ZROZ',
        name: 'PIMCO 25+ Year Zero Coupon U.S. Treasury Index ETF',
        duration: 'extended',
        managementStyle: 'passive',
        yield: 4.99,
        expenseRatio: 0.15,
    ...
    {
        ticker: 'VGSH',
        name: 'Vanguard Short-Term Treasury Index Fund ETF',
        duration: 'short',
        managementStyle: 'passive',
        yield: 3.76,
        expenseRatio: 0.03,
    ...
    {
        ticker: 'VGIT',
        name: 'Vanguard Intermediate-Term Treasury Index Fund ETF',
        duration: 'intermediate',
        managementStyle: 'passive',
        yield: 3.95,
        expenseRatio: 0.03,
    ...
    {
        ticker: 'VGLT',
        name: 'Vanguard Long-Term Treasury Index Fund ETF',
        duration: 'long',
        managementStyle: 'passive',
        yield: 4.9,
        expenseRatio: 0.03,
    ...
    {
        ticker: 'EDV',
        name: 'Vanguard Extended Duration Treasury Index Fund ETF',
        duration: 'extended',
        managementStyle: 'passive',
        yield: 5.19,
        expenseRatio: 0.05,

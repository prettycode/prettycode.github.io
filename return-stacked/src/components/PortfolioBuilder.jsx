...
const PortfolioBuilder = ({ 
  ...
  const handleAllocationChange = (changedEtf, newValue) => {
    ...
    const unlockedEtfs = selectedETFs.filter(etf => 
      etf !== changedEtf && !lockedETFs.has(etf) && !disabledETFs.has(etf)
    );
  ...
  const availableETFs = Object.keys(ETF_DATA).filter(etf => 
...
export { PortfolioBuilder, ETF_DATA, ASSET_CLASSES, EQUITY_CLASSES, COLOR_CLASSES, parseExposures }; 
...
export const etfCatalog = [
  ...
  createETF(
    "TMF",
    [{ exposure: { assetClass: "U.S. Treasuries" }, amount: 3.0 }],
    "Daily Reset"
  ),
  createETF(
    "GOVZ",
    [{ exposure: { assetClass: "U.S. Treasuries" }, amount: 1.6 }],
    "Extended Duration"
  ),
  createETF("TLT", [
    { exposure: { assetClass: "U.S. Treasuries" }, amount: 1.0 },
  ...
  createETF(
    "UGL",
    [{ exposure: { assetClass: "Gold" }, amount: 2.0 }],
    "Daily Reset"
  ),
...
export const analyzePortfolio = (portfolio) => {
  ...
  for (const [ticker, holdingData] of portfolio.holdings) {
    ...
    const percentage =
      typeof holdingData === "object" ? holdingData.percentage : holdingData;

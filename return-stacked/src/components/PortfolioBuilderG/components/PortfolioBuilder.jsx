                            ...
                            <Card className="bg-gradient-to-br from-muted/30 to-muted/10 border border-border/40 py-0">
                                <CardContent className="p-6 flex flex-col items-center justify-center h-[220px] text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground max-w-md mb-4">
                                        Start by adding ETFs above or switch to the Templates tab to use a pre-built
                                        portfolio.
                                    </p>
                                    <button
                                        ...
                                        >
                                            ...
                                            <div className="flex border-t border-border/40">
                                                <button
                                                    ...
                                                    className="flex-1 py-2 text-xs font-medium text-center hover:bg-muted/50 transition-colors text-foreground"
                                                >
                                                    Load
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className="flex-1 py-2 text-xs font-medium text-center hover:bg-red-50 hover:text-red-600 transition-colors text-muted-foreground"
                                                >
                                                    Delete
                                                </button>
                                            </div>
